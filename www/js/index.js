...
var documentId = 'urn:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bmVpbHNvZnQxMjExMDA5OTk5ZHFpMWJzenc0cGN0NGN0N3dkZWtjNHJ6cnkxaWxnL0xlZ29IZWxpY29wdGVyLmYzZA==';
...
function openNextModel(){
    this.documentId = 'urn:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bmVpbHNvZnQxMjExMDA5OTk5ZHFpMWJzenc0cGN0NGN0N3dkZWtjNHJ6cnkxaWxnL0hvdXNlLmR3Zng=';
    console.log("openNextModel() : this.documentId : "+this.documentId);
    Autodesk.Viewing.Document.load(this.documentId, onDocumentLoadSuccess, onDocumentLoadFailure);
}
...
function changeBackground (){
    viewer.setBackgroundColor( 0, 0, 255, 255, 255, 255 )
}
